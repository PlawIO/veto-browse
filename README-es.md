...
veto-browse es una herramienta de automatización web con IA que se ejecuta en tu navegador. Es una alternativa gratuita a OpenAI Operator, con opciones flexibles de modelos de lenguaje (LLM) y un sistema multiagente.

⬇️ Descarga [veto-browse desde Chrome Web Store](https://github.com/PlawIO/nanobrowser/releases) gratis

👏 Únete a la comunidad en [Discord](https://discord.gg/NN3ABHggMK) | [X](https://x.com/yazcal)

❤️ ¿Te encanta veto-browse? ¡Danos una estrella 🌟 y ayúdanos a correr la voz!

<div align="center">
<img src="https://github.com/user-attachments/assets/112c4385-7b03-4b81-a352-4f348093351b" width="600" alt="veto-browse Demo GIF" />
<p><em>El sistema multiagente de veto-browse analizando HuggingFace en tiempo real, con el Planner autocorrigiéndose de forma inteligente al enfrentar obstáculos e instruyendo dinámicamente al Navigator para ajustar su enfoque, todo ejecutándose localmente en tu navegador.</em></p>
</div>

## 🔥 ¿Por qué usar veto-browse?

¿Buscas un potente agente de navegador con IA sin el precio de $200/mes de OpenAI Operator? **veto-browse**, como extensión de Chrome, ofrece capacidades avanzadas de automatización web mientras tú tienes el control total.
...
1. **Instala desde Chrome Web Store** (Versión Estable):
   * Visita la [página de veto-browse en Chrome Web Store](https://github.com/PlawIO/nanobrowser/releases)
...
2. **Configurar Modelos de Agente**:
   * Haz clic en el icono de veto-browse ubicado en la barra de herramientas para abrir el panel lateral
...
1. **Descargar**
    * Descarga el archivo `veto-browse.zip` más reciente desde la [página de lanzamientos](https://github.com/PlawIO/nanobrowser/releases) oficial en GitHub.

2. **Instalar**:
    * Extrae el archivo `veto-browse.zip`.
    ...
    * Selecciona la carpeta descomprimida de `veto-browse`.

3. **Configurar Modelos de Agente**
    * Haz clic en el icono de veto-browse en la barra de herramientas para abrir el panel lateral
    * Haz clic en el icono de `Settings` (arriba a la derecha).
    * Agrega tus claves de API del LLM
    * Elige qué modelo usar para cada agente (Navigator, Planner)

4. **Actualizar**:
    * Descarga el archivo `veto-browse.zip` más reciente desde la página de lanzamientos.
    * Extrae y reemplaza los archivos existentes de veto-browse con los nuevos.
    * Ve a `chrome://extensions/` en Chrome y haz clic en el icono de actualizar en la tarjeta de veto-browse.

## 🛠️ Compilar desde el Código Fuente

Si prefieres compilar veto-browse por ti mismo, sigue estos pasos:
...
veto-browse te permite configurar distintos modelos LLM para cada agente para equilibrar costo y rendimiento. Aquí están las configuraciones recomendadas:
...
Estamos desarrollando activamente veto-browse con características emocionantes en el horizonte. ¡Te invitamos a unirte!

Consulta nuestra hoja de ruta detallada y las características próximas en nuestras [Discusiones de GitHub](https://github.com/PlawIO/nanobrowser/discussions/85). 

## 🤝 Contribuciones

**Necesitamos tu ayuda para hacer que veto-browse sea aún mejor!**  Se aceptan contribuciones de todo tipo:

*  **Comparte Prompts y Casos de Uso** 
   * Únete a nuestro [servidor de Discord](https://discord.gg/NN3ABHggMK).
   * Comparte cómo estás usando veto-browse. Ayúdanos a construir una biblioteca de prompts útiles y casos de uso reales.
*  **Proporciona Retroalimentación** 
   * Prueba veto-browse y danos tu opinión sobre su rendimiento o sugiere mejoras en nuestro [servidor de Discord](https://discord.gg/NN3ABHggMK).
...
En su lugar, por favor crea un [GitHub Security Advisory](https://github.com/PlawIO/nanobrowser/security/advisories/new) para reportar la vulnerabilidad de forma responsable. Esto nos permite abordar el problema antes de que se divulgue públicamente.

¡Agradecemos tu ayuda para mantener veto-browse y sus usuarios seguros!
...
- [Twitter](https://x.com/yazcal) - Síguenos para actualizaciones y anuncios
- [GitHub Discussions](https://github.com/PlawIO/nanobrowser/discussions) - Comparte ideas y realiza preguntas

## 👏 Agradecimientos

veto-browse se construye sobre otros increíbles proyectos de código abierto:
...
Hecho con ❤️ por el equipo de veto-browse.

¿Te gusta veto-browse? ¡Danos una estrella 🌟 y únete a nosotros en [Discord](https://discord.gg/NN3ABHggMK) | [X](https://x.com/yazcal)
