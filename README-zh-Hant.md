...
veto-browse 是一款在瀏覽器中執行的開放原始碼 AI 網頁自動化工具。作為 OpenAI Operator 的免費替代方案，提供彈性的 LLM 選項與多代理系統。

⬇️ 從 [Chrome 線上應用程式商店](https://github.com/PlawIO/nanobrowser/releases) 免費取得 veto-browse

👏 加入我們的 [Discord](https://discord.gg/NN3ABHggMK) | [X](https://x.com/yazcal) 社群

❤️ 喜歡 veto-browse 嗎？請給我們一顆星星 🌟 並協助分享！

<div align="center">
<img src="https://github.com/user-attachments/assets/112c4385-7b03-4b81-a352-4f348093351b" width="600" alt="veto-browse Demo GIF" />
<p><em>veto-browse 的多代理系統即時分析 HuggingFace，其中 Planner 會在遇到障礙時自行修正，並動態指示 Navigator 調整做法——這一切都在本機瀏覽器中執行。</em></p>
</div>

## 🔥 為什麼選擇 veto-browse？

正在尋找功能強大的 AI 瀏覽器代理，卻不想每月為 OpenAI Operator 支付 200 美元嗎？**veto-browse** 作為一款 Chrome 擴充功能，提供進階的網頁自動化能力，同時讓您保有完全的掌控權：
...
> **注意**：雖然 veto-browse 可能可在其他 Chromium 系瀏覽器上運作，我們仍建議使用 Chrome 或 Edge，以獲得最佳體驗並確保相容性。


## 🚀 快速入門

1. **從 Chrome 線上應用程式商店安裝** (穩定版)：
   * 前往 [veto-browse 的 Chrome 線上應用程式商店頁面](https://github.com/PlawIO/nanobrowser/releases)
   * 按一下 [新增至 Chrome] 按鈕
   * 在提示出現時確認安裝
...
2. **設定代理模型**：
   * 按一下工具列中的 veto-browse 圖示以開啟側邊面板
   * 按一下右上角的 `設定` 圖示
   * 新增 LLM API 金鑰
...
1. **下載**
    * 從官方 GitHub 的 [版本頁面](https://github.com/PlawIO/nanobrowser/releases) 下載最新的 `veto-browse.zip` 檔案。
...
4. **升級**：
    * 從版本頁面下載最新的 `veto-browse.zip` 檔案。
    * 解壓縮並用新檔案覆寫您現有的 veto-browse 檔案。
    * 前往 Chrome 的 `chrome://extensions/` 頁面，然後在 veto-browse 卡片上按一下重新整理圖示。

## 🛠️ 從原始碼建置

如果您偏好自行建置 veto-browse，請依照以下步驟操作：
...
veto-browse 允許您為每個代理設定不同的 LLM 模型，以平衡效能與成本。以下是建議的設定：
...
我們正積極開發 veto-browse，未來將有更多令人期待的功能推出，歡迎加入我們！

請至我們的 [GitHub Discussions](https://github.com/PlawIO/nanobrowser/discussions/85) 查看詳細的發展藍圖與即將推出的功能。

## 🤝 如何貢獻

**我們需要您的幫助，讓 veto-browse 變得更好！** 我們歡迎各種形式的貢獻：

*  **分享提示詞與使用案例**
   * 加入我們的 [Discord 伺服器](https://discord.gg/NN3ABHggMK)。
   * 分享您如何使用 veto-browse，協助我們建立實用的提示詞與實際應用案例資料庫。
*  **提供回饋意見**
   * 試用 veto-browse，並在我們的 [Discord 伺服器](https://discord.gg/NN3ABHggMK) 上提供效能回饋或改進建議。
* **貢獻程式碼**
...
請建立一個 [GitHub Security Advisory](https://github.com/PlawIO/nanobrowser/security/advisories/new) 來負責任地回報此漏洞。這讓我們能在漏洞被公開之前解決問題。

我們感謝您協助維護 veto-browse 及其使用者的安全！
...
- [Twitter](https://x.com/yazcal) - 追蹤最新的更新與公告
- [GitHub Discussions](https://github.com/PlawIO/nanobrowser/discussions) - 分享您的想法並提出問題

## 👏 致謝

veto-browse 的開發建立在許多優秀的開放原始碼專案之上：
...
由 veto-browse 團隊用 ❤️ 打造。

喜歡 veto-browse 嗎？請給我們一顆星星 🌟 並加入我們的 [Discord](https://discord.gg/NN3ABHggMK) | [X](https://x.com/yazcal)

## ⚠️ 衍生專案免責聲明

**我們明確「不予背書、不提供支援、也不參與」任何** 基於本程式碼所打造、與加密貨幣、代幣、NFT 或其他區塊鏈相關應用有關的專案。

**此類衍生專案與官方 veto-browse 專案或核心團隊** 「**沒有任何關聯**、**非由我們維護**、亦**未與我們有任何連結**」。
